...
//	GPIO_Init(SL_SPI_MOSI_PORT, &GPIO_InitStructure);
  ...
  HAL_GPIO_WritePin(SL_SPI_SCK_PORT, SL_SPI_SCK_PINS, GPIO_PIN_SET);
	HAL_GPIO_WritePin(SL_SPI_MOSI_PORT, SL_SPI_MOSI_PINS, GPIO_PIN_SET);
	HAL_GPIO_WritePin(SL_SPI_MISO_PORT, SL_SPI_MISO_PINS, GPIO_PIN_SET);
	
  GPIO_InitStruct.Pin = SL_SPI_SCK_PINS;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(SL_SPI_SCK_PORT, &GPIO_InitStruct);
	
	GPIO_InitStruct.Pin = SL_SPI_MOSI_PINS;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(SL_SPI_MOSI_PORT, &GPIO_InitStruct);
	
	GPIO_InitStruct.Pin = SL_SPI_MISO_PINS;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(SL_SPI_MISO_PORT, &GPIO_InitStruct);
